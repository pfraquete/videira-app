        ...
        <View className="mx-6 mb-6">
          ...
          <View className="bg-surface rounded-2xl border border-border overflow-hidden">
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <View className="w-10 h-10 rounded-full bg-teal-500/20 items-center justify-center">
                <Text className="text-lg">📅</Text>
              </View>
              <Text className="flex-1 ml-3 text-foreground font-medium">Escala de Servos</Text>
              <IconSymbol name="chevron.right" size={20} color={colors.muted} />
            </TouchableOpacity>
